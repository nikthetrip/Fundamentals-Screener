...
# I rapporti derivati (ROIC, conversione in cassa, payout, earnings yield e gli
# altri) stanno in derived_metrics.py e non piu' qui: da quando il dataset ha
# due lettori — questa dashboard e l'app iOS — il codice che li calcola deve
# essere uno solo, o i due mostrerebbero due ROIC diversi per la stessa societa'.
from derived_metrics import ROIC_TAX_RATE, derive_ratios  # noqa: E402
...
# ===========================================================================
# CATALOGO DELLE METRICHE, FORMATI E CONFRONTI
#
# Stavano qui. Sono in metrics_catalog.py da quando i lettori del dataset sono
# tre — questa dashboard, il generatore delle spiegazioni per l'app iOS e la
# build che calcola i commenti — e un catalogo ricopiato in tre posti diverge
...
# La cache resta qui e non nel modulo: e' una funzione di Streamlit, e quel
# modulo deve poter essere importato anche da uno script che Streamlit non lo
# esegue affatto.
peer_medians = st.cache_data(show_spinner=False)(_catalog.peer_medians)
